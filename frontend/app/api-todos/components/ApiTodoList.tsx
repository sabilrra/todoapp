...
export interface ApiTodoListProps {
          ...
          tasks.map((task) => (
            ...
            >
              <div className="flex items-start sm:items-center gap-3.5 flex-1 pr-2">
                ...
                <div>
                  <p
                    className={`text-xs md:text-sm font-medium leading-relaxed transition-all ${task.completed ? 'line-through text-gray-80' : 'text-dark-70 group-hover:text-primary-100'}`}
                  >
                    {task.title}
                  </p>
